  ...
  return (
    <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className="relative w-full overflow-hidden">
        ...
        >
          {/* Card wrapper */}
          <div className="flex gap-6 px-8 md:px-16 py-10 md:py-20">
        ...
        {/* Navigation buttons */}
        <div className="flex justify-end gap-2 mt-4 px-8">
          <button
            className="relative z-30 h-10 w-10 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center disabled:opacity-50 transition-colors hover:bg-white/20"
            onClick={scrollLeft}
